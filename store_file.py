...
class Buffer:
    ...
    def update(self, uav_info: list, car_info: list, rate_info: list, channel_info: list):
        ...
        # rate
        self.rate_info["rate"][self.time, :] = rate_info[0]
    ...
    def clear(self):
        ...
        self.rate_info = {"all_rate": np.zeros(shape=(self.max_time, self.car_num), dtype=np.float32),
...
if __name__ == "__main__":
    ...
    rate_info_4 = np.array([4, 5])
    rate_info = [rate_info_1, rate_info_2, rate_info_3, rate_info_3.mean(), rate_info_4]
